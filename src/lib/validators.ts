...
export const productSchema = z.object({
	...
	line: z.string().min(1, 'La linea del producto es obligatoria'),
  compression_level :z.string().min(1, 'El nivel de compresion es obligatoria'),
  category :z.string().min(1, 'La catergoria del producto es obligatoria'),
	slug: z
		.string()
	...
	variants: z
		.array(
			z.object({
				...
				size: z.string().min(1, 'La talla es requerido'),
				color: z
					.string()
					.regex(
